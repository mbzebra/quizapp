...
import HistoryQuiz from '../Components/HistoryQuiz'; // Ensure this path is correct
...
const HistoryLesson = () => {
  ...
  useEffect(() => {
    import(`../History/lesson${lessonNumber}/questions.json`)
      .then((data) => {
    ...
    <Container className="d-flex vh-100">
      ...
      <Modal show={showModal} onHide={handleClose} size="lg" centered>
        <Modal.Header closeButton>
          <Modal.Title>History Quiz {lessonNumber}</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          {questions ? (
